    ...
    <>
      ...
      <div className="container mt-5">
        ...
        <form className="d-flex flex-column" onSubmit={formik.handleSubmit}>
          ...
          <label className="mt-4 mb-2 " htmlFor="rePassword">
            Re-password :
          </label>
          <input
            onBlur={formik.handleBlur}
          ...
          {formik.errors.rePassword && formik.touched.rePassword ? (
            <div className="alert alert-danger">
              Re-Password pattern is Invalid
            </div>
          ) : (
            ""
          )}

          <label className="mt-4 mb-2 " htmlFor="phone">
            Phone :
          </label>
          <input
            onBlur={formik.handleBlur}
          ...
          {formik.errors.phone && formik.touched.phone ? (
            <div className="alert alert-danger">Invalid Phone</div>
          ) : (
            ""
          )}
          ...
          <div className="w-100 d-flex justify-content-end ">
            <button
              type="submit"
              className="btn btn-success py-2 px-4 mt-4 fs-4"
      ...
      {loading ? (
        <div className="d-flex justify-content-center align-content-center position-absolute top-0 start-0 end-0 bottom-0 ">
